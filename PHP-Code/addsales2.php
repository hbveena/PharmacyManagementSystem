    ...
    <div id="wrapper">
       ...
       <div id="div2" class="scroll">
        <form action="as1.php" method="POST">
          ...
          <p>INVOICE NO:</p>
            <input type="text" name="invoiceno" id="adtext" value="<?php session_id("session7");session_start(); echo($_SESSION['invoiceno']);session_write_close();?>"required><br>
            <p>INVOICE DATE:</p>
            <input type="date" id="adtext" name="invoicedate" required><br>
          <p>STAFF ID:</p> <input type="text" name="sid" id="adtext" value="<?php session_id("session1");session_start(); echo($_SESSION['SID']);?>" readonly><br>
